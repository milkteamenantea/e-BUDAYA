<?php
  ...
  if( isset($_POST['edit']) && $_POST['edit'] == "Simpan Data" ) {
    ...
    if($query) {
     echo "<script>if(alert('Data Berhasil Disimpan...')){window.location.href='page_provinsi.php';}</script>";
    }
  }
...
?>
  <html>
    ...
    <body>
      <h2 style="color: #520074; margin: 10px 5px; font-family: Calibri; font-style: italic; font-size: 35px;"><b>Provinsi</b></h2>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Page::Provinsi</li>
        </ol>
      </nav>
            ...
            <div class="card-body" style="padding: 20px;">
              <form action="" method="POST">
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" name="isi" rows="2" placeholder="Masukkan Isi Provinsi"><?=$data['isi_pages'];?></textarea>
                    </div>
                  </div>
                  <div class="col-10">
