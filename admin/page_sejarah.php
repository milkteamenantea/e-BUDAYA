<?php
  ...
  if( isset($_POST['edit']) && $_POST['edit'] == "Simpan Data" ) {
    ...
    if($query) {
     echo "<script>if(alert('Data Berhasil Disimpan...')){window.location.href='page_sejarah.php';}</script>";
    }
  }
...
?>
  <html>
    ...
    <body>
      <h2 style="color: #520074; margin: 10px 5px; font-family: Calibri; font-style: italic; font-size: 35px;"><b>Sejarah</b></h2>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Page::Sejarah</li>
        </ol>
      </nav>
      <div class="max-auto" style="width: 100%;">
          <div class="card">
            <div class="card-header bg-primary text-white">
              <b>Create / Edit Data Sejarah</b>
            </div>
            <div class="card-body" style="padding: 20px;">
              <form action="" method="POST">
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" name="isi" rows="2" placeholder="Masukkan Isi Sejarah"><?=$data['isi_pages'];?></textarea>
                    </div>
                  </div>
                  <div class="col-10">
